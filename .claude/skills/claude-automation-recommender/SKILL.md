...
- **`references/hooks-patterns.md`** - Detailed hook configurations by framework
- **`references/mcp-servers.md`** - MCP server catalog with detection signals
- **`references/plugins-reference.md`** - Official plugin directory
- **`references/subagent-templates.md`** - Subagent templates by use case
- **`references/skills-reference.md`** - Skill patterns and examples
